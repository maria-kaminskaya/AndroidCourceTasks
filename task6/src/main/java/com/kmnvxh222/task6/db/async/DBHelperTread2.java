...
/**
 * 2.CompletableFuture + ThreadPoolExecutor
 */
class DBHelperTread2 extends SQLiteOpenHelper implements DBInterface {

    public DBHelperTread2(@androidx.annotation.Nullable Context context, @androidx.annotation.Nullable String name, @androidx.annotation.Nullable SQLiteDatabase.CursorFactory factory, int version) {
